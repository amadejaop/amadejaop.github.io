        ...
        <>
            <nav className="fixed flex justify-center bg-white shadow-[rgba(17,_17,_26,_0.1)_0px_0px_16px] w-full px-7 z-50">
                ...
                <ul className="hidden md:flex items-center gap-5 font-light">
                    <li className="px-3"><a className="link text-xl font-medium" href="#about">About</a></li>
                    <li className="px-3"><a className="link text-xl font-medium" href="#projects">Projects</a></li>
                    <li className="px-3"><a className="link text-xl font-medium" href="#blog">Blog</a></li>
                    <li className="px-3"><a className="link text-xl font-medium" href="#contact">Contact</a></li>
                </ul>
                </div>
