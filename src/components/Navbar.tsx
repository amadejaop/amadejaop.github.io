        ...
        <>
            <nav className="fixed flex justify-center bg-white shadow-[rgba(17,_17,_26,_0.1)_0px_0px_16px] w-full px-7 z-50">
                ...
                <ul className="hidden md:flex items-center gap-2 font-light">
                    <li className="px-3"><a className="text-xl font-medium navlink" href="#about">About</a></li>
                    <li className="px-3"><a className="text-xl font-medium navlink" href="#projects">Projects</a></li>
                    <li className="px-3"><a className="text-xl font-medium navlink" href="#blog">Blog</a></li>
                    <li className="px-3"><a className="text-xl font-medium navlink" href="#contact">Contact</a></li>
                </ul>
                </div>
                <button className="md:hidden" onClick={toggleNavbar}><svg width="55px" height="55px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" transform="matrix(-1, 0, 0, 1, 0, 0)"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M4 6H20M4 12H14M4 18H9" stroke="#27272a" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg></button>
            </nav>
            <ul className={`flex flex-col items-center justify-center gap-10 text-2xl font-light p-4 h-screen w-screen ${isOpen ? 'translate-y-0' : '-translate-y-full'} ease-in-out duration-500 bg-white absolute z-50`}>
                    <button className="absolute top-1.5 right-6" onClick={toggleNavbar}><svg width="60px" height="60px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#27272a"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M6 6L18 18M18 6L6 18" stroke="#27272a" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg></button>
